...
func (c *OVClient) CreateApplianceTimeandLocal(timelocal TimeLocal) error {
...
func (c *OVClient) GetApplianceTimeandLocals(filter string, sort string, start string, count string)) (TimeLocal, error) {
	var (
		uri                    = "/rest/appliance/configuration/time-locale"
		q                      = make(map[string]interface{})
		applianceTimeandLocals TimeLocal
	)
